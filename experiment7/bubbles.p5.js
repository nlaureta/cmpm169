...
function Bubbles (_source, _parent, _onselect, _tiptext)
{
    ...
    this.preload = function ()
    {
        this.init ();
        var self = this;
        img[0] = loadImage('movie1.jpg');
        img[1] = loadImage('human-population.jpg');
        img[2] = loadImage('social-media.jpg');
        img[3] = loadImage('games.png');
        img[4] = loadImage('music.jpg');
        //img = img1;
    ...
    this.checkButton1 = function(buttonId) {
            console.log(buttonId);
            if (buttonId === topMovies) {
                currentImage = 0;
              console.log("Button 1 was pressed1");
            } else if (buttonId === topPop) {
                currentImage = 1;
              console.log("Button 2 was pressed1");
            } else if(buttonId === topSM){
                currentImage = 2;
              console.log("Unknown button was pressed1");
